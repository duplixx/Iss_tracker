...
export default function SpeedoMeter() {
    ...
    function speedo() {
        for (var i = 1; i <= 22; i++) {
            ...
            document.getElementById("a"+i).classList.remove("fill-white");
            document.getElementById("a"+i).classList.add("fill-red-500");
        }
    }
        ...
        <>
            <div className="w-[50%] text-center">
                <div className="flex items-center justify-center relative">
                    <svg
                        className="js-guage-svg guage-svg h-[15vh] w-[100%]"
                ...
                <span className="font-sans text-white text-2xl font-bold">{speed || 27378} km/h</span>
                
            </div>
            <div className="w-[50%] text-center ">
                <div className="flex items-center justify-center relative">
                    <svg
                        className="js-guage-svg1 guage-svg h-[15vh] w-[100%]"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 327 205.4"
                    >
                        <path
                ...
                <span className="font-sans text-white text-2xl font-bold">{alt || 462} km</span>
            </div>
